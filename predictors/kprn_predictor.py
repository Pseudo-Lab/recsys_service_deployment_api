...
class KPRNPredictor:
    ...
    def predict(self, dbids: List):
        ...
        movie_to_paths = find_paths_user_to_movies(my_idx, self.movie_person, self.person_movie, self.movie_user,
                                                   self.user_movie, 3, 60)
        movie_to_paths_len5 = find_paths_user_to_movies(my_idx, self.movie_person, self.person_movie, self.movie_user,
                                                        self.user_movie, 5, 6)
